        ...
        <div class="container">
            ...
            <form class="form-horizontal" role="form" method="post" action="index.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="host" id="inputUsername3"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="port" id="inputUsername3" placeholder="22"
                               required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="username" id="inputUsername3" placeholder="root"
                               required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="password" id="inputPassword3"
                               placeholder="ssh password or path to ssh key" required>

                        <p>Note: if your SSH key has a passphrase, please enter it after the key path, separated with a
                            space (like /path/to/key password)</p>
                    </div>
                </div>
                <div class="form-group">
